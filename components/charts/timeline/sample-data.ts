...
export const sampleData: TimelineData = {
  ...
  events: [
    ...
    { date: '1341-06-01', label: 'Saltmarsh trade pact signed', track: 'faction', source: 'historian/events/saltmarsh-pact.md' },
    ...
    { date: '1342-06-15', label: 'Cult of the Hollow surfaces', track: 'faction', source: 'historian/events/cult-surfaces.md' },
    { date: '1342-06-20', label: 'Tax revolt in the lowlands', track: 'world', minor: true },
    { date: '1342-08-01', label: 'Redfen burns', track: 'world', major: true, source: 'historian/events/redfen-burns.md' },
    { date: '1343-01-10', label: 'Continent split by the Sundering', track: 'continent', major: true, source: 'historian/events/the-sundering.md' },
    { date: '1343-04-22', label: 'New trade route to Highport opens', track: 'faction' },
    { date: '1343-09-30', label: 'Mara confronts the killer', track: 'character', major: true, source: 'historian/events/mara-confronts.md' },
