...
export const sampleData: TimelineData = {
  ...
  events: [
    ...
    { date: '1342-07-01', label: 'The Hollow\'s true patron revealed', track: 'faction:Cult of the Hollow', secret: true, source: 'historian/events/hollow-patron.md' }, // DM-only
    { date: '1342-07-05', label: 'Mara overhears the cult\'s plan', track: 'character:Mara', knownBy: ['Mara'], source: 'historian/events/mara-overhears.md' }, // only Mara knows
    { date: '1342-07-12', label: 'Borin and Mara find the ledger', track: 'character:Borin', knownBy: ['Borin', 'Mara'], source: 'historian/events/the-ledger.md' }, // those two know
