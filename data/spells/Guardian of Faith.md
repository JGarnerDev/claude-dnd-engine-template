...
duration: "8 hours"
concentration: false
effect: "A Large spectral guardian appears and hovers for the duration in an unoccupied space within range. Any hostile creature that moves to within 10 feet of the guardian for the first time on a turn must make a Dexterity save: 20 radiant damage on fail, half on success. The guardian vanishes when it has dealt a total of 60 damage."
available_to:
  - Cleric
