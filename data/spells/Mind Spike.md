...
concentration: true
effect: "Target a creature you can see within range. It must make a Wisdom save. On fail: 3d8 psychic damage and you always know the target's location for the duration, even if it's on a different plane. On success: half damage and no location tracking. At higher levels: +1d8 per slot level above 2nd."
available_to:
  - Sorcerer
  - Warlock
  - Wizard
