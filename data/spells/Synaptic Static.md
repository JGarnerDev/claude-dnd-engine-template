...
concentration: false
effect: "Choose a point within range and cause psychic energy to explode there. Each creature in a 20-foot sphere centered on that point must make an Intelligence save. On fail: 8d6 psychic damage and short-term mental static. While affected (until the creature's next long rest, but can make Intelligence save at end of each turn to end it earlier): it subtracts 1d6 from attack rolls, ability checks, and concentration checks."
available_to:
  - Bard
  - Sorcerer
  - Warlock
