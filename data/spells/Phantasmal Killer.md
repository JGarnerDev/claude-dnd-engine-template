...
concentration: true
effect: "Tap into the nightmares of a creature within range to create an illusory manifestation of its deepest fears. The target makes a Wisdom save. On fail: frightened for the duration. At end of each turn while frightened, the target makes a Wisdom save: on fail, 4d10 psychic damage. On success, the spell ends. At higher levels: +1d10 per slot level above 4th."
available_to:
  - Wizard
